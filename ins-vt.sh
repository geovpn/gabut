...
cd /usr/bin
wget -O add-ws "https://istriku.me/gabut/add-ws.sh"
wget -O add-vless "https://istriku.me/gabut/add-vless.sh"
wget -O cek-ws "https://istriku.me/gabut/cek-ws.sh"
wget -O cek-vless "https://istriku.me/gabut/cek-vless.sh"
wget -O del-ws "https://istriku.me/gabut/del-ws.sh"
wget -O del-vless "https://istriku.me/gabut/del-vless.sh"
wget -O renew-ws "https://istriku.me/gabut/renew-ws.sh"
wget -O renew-vless "https://istriku.me/gabut/renew-vless.sh"
wget -O add-tr "https://istriku.me/gabut/add-tr.sh"
wget -O del-tr "https://istriku.me/gabut/del-tr.sh"
wget -O cek-tr "https://istriku.me/gabut/cek-tr.sh"
wget -O renew-tr "https://istriku.me/gabut/renew-tr.sh"
chmod +x add-ws
chmod +x add-vless
chmod +x del-ws
chmod +x del-vless
