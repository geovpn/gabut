...
# Tambahan
cd /usr/bin
wget -O add-wg "https://istriku.me/gabut/add-wg.sh"
wget -O del-wg "https://istriku.me/gabut/del-wg.sh"
wget -O cek-wg "https://istriku.me/gabut/cek-wg.sh"
wget -O renew-wg "https://istriku.me/gabut/renew-wg.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
