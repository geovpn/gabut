...
cd /usr/bin
wget -O add-ss "https://istriku.me/gabut/add-ss.sh"
wget -O del-ss "https://istriku.me/gabut/del-ss.sh"
wget -O cek-ss "https://istriku.me/gabut/cek-ss.sh"
wget -O renew-ss "https://istriku.me/gabut/renew-ss.sh"
chmod +x add-ss
chmod +x del-ss
chmod +x cek-ss
chmod +x renew-ss
